...
$this->add_control(
      ...
      [
        ...
        'options' => [
          ...
          'Starter' => esc_html__( 'Starter', 'textdomain' ),
          'Professional' => esc_html__( 'Professional', 'textdomain' ),
        ],
...
$this->add_control(
      ...
      [
        'type' => \Elementor\Controls_Manager::SELECT,
        'label' => esc_html__( 'Select Time Period', 'textdomain' ),
        'options' => [
          'MONTH' => esc_html__( 'Month', 'textdomain' ),
          'YEAR' => esc_html__( 'Year', 'textdomain' ),
          'LIFETIME' => esc_html__( 'Lifetime', 'textdomain' ),
        ],
        'default' => 'MONTH',
      ]
    );
    ...
    'price',
      [
        ...
        'default' => esc_html__( '20$', 'elementor-addon' ),
      ]
    ...
    'Features',
      [
        ...
        'placeholder' => esc_html__( 'Write details here', 'textdomain' ),
      ]
    );
    $this->add_control(
    'iconclass',
      [
        ...
        'type' => \Elementor\Controls_Manager::TEXT,
        'default' => esc_html__( 'ion-android-remove', 'elementor-addon' ),
        'placeholder' => esc_html__( 'write class name', 'textdomain' ),
        'discription' => esc_html__( 'for help.', 'elementor-addon')
       ]
    );
    ...
    'bgcolor',
      [
        ...
        'default' => esc_html__( '#02CECC', 'elementor-addon' ),
      ]
    );
        $this->add_control(
            'textcolor',
...
<div class="wrapper">
    <div class="plan featured">
        <header>
            ...
            <div class="plan-cost"><span class="plan-price"><?php echo $settings['price'] ?></span><span class="plan-type">/<?php echo $settings['Select Time Period'] ?></span></div>
        </header>
